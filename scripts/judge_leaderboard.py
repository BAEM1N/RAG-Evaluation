...
Input: results/phase5_judge_consolidated/judge_<judge>__expB__gemma-embed-300m__<llm>.json
Output: prints markdown leaderboard + writes results/phase5_judge_consolidated/LEADERBOARD.md
"""
import json, glob, re
...
JDIR = BASE / "results" / "phase5_judge_consolidated"
