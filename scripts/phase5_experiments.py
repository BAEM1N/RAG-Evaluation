...
Usage:
  python phase5_experiments.py --exp A --server gpu
  python phase5_experiments.py --exp B --server gpu
...
def main():
    ...
    parser.add_argument(
        "--server", required=True, choices=["gpu", "spark"]
    )
