...
전체 결과 데이터: [HuggingFace 데이터셋](https://huggingface.co/datasets/BAEM1N/Korean-RAG-LLM-Judge-Benchmark) (results/ 는 repo 에 포함하지 않음)
...
| gpt-oss:120b | HP Z2 Mini | MXFP4 | — |
| gpt-oss:20b | HP Z2 Mini | MXFP4 | — |
...
| qwen3.5:27b | HP Z2 Mini | Q8_0 | nothink |
...
| nemotron-120b (nothink) | HP Z2 Mini | 12/12 |
| qwen3.5:122b-a10b (nothink) | Mac ollama | 12/12 |
| qwen3.6-35b-a3b (nothink) | HP Z2 Mini | 12/12 |
| supergemma4-26b (nothink) | HP Z2 Mini | 12/12 |
| qwen3-next:80b (nothink) | DGX Spark ollama | partial (3/12) |
| qwen3.5-27b-claude-distill (nothink) | HP Z2 Mini | partial (0/12) |
