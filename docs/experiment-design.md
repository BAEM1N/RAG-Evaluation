...
| Host | Runtime | Models |
|------|---------|--------|
| HP Z2 Mini (AMD MI100 96GB VRAM) | llama.cpp / llama-server | qwen3.5-27b Q8, qwen3.5-9b, EXAONE, Midm, SuperGemma4-26b, nemotron-120b (judge), qwen3.6-35b-a3b (judge), qwen3.5-27b-claude-distill (judge) |
...
- HP Z2 Mini scripts: `ThreadPoolExecutor(max_workers=4)`
...
| 5A Generation (12 configs) | 1–2 days (HP Z2 Mini + Spark in parallel) |
